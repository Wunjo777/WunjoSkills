...
echo "║       New-Item -ItemType Directory -Force \\              ║"
echo "║         -Path ~\\.claude\\claudecode-popper | Out-Null    ║"
echo "║       irm $REPO_BASE/remote/listener.ps1 \\               ║"
echo "║         -OutFile ~\\.claude\\claudecode-popper\\listener.ps1║"
echo "║       powershell -File ~\\.claude\\claudecode-popper\\listener.ps1║"
echo "║                                                          ║"
