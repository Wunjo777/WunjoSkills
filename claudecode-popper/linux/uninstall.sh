...
# One-line: curl -fsSL https://raw.githubusercontent.com/Wunjo777/WunjoAgentTools/master/claudecode-popper/linux/uninstall.sh | bash
...
echo "Claude Code Popper - Linux Uninstaller"
