...
**Windows** (PowerShell):
```powershell
irm https://raw.githubusercontent.com/Wunjo777/WunjoAgentTools/master/windows/install.ps1 | iex
```

**Linux** (Bash):
```bash
curl -fsSL https://raw.githubusercontent.com/Wunjo777/WunjoAgentTools/master/linux/install.sh | bash
```

**macOS** (Bash):
```bash
curl -fsSL https://raw.githubusercontent.com/Wunjo777/WunjoAgentTools/master/macos/install.sh | bash
```
...
**Windows**:
```powershell
irm https://raw.githubusercontent.com/Wunjo777/WunjoAgentTools/master/windows/uninstall.ps1 | iex
```

**Linux**:
```bash
curl -fsSL https://raw.githubusercontent.com/Wunjo777/WunjoAgentTools/master/linux/uninstall.sh | bash
```

**macOS**:
```bash
curl -fsSL https://raw.githubusercontent.com/Wunjo777/WunjoAgentTools/master/macos/uninstall.sh | bash
```
